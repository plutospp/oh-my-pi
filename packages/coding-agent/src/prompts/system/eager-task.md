...
Work alone: editing or updating Markdown (.md) files | direct answer requiring no code changes | command user explicitly asked you to run | only ONE runnable slice — lone subagent lossy handoff, not parallelism.
</system-reminder>
